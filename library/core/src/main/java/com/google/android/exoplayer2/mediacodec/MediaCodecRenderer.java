      ...
      try {
          try {
              ...
              if (codecInfo == preferredCodecInfo) {
                  // If creating the preferred decoder failed then sleep
                  // briefly before retrying. Workaround for [internal
                  // b/191966399]. See also
                  // https://github.com/google/ExoPlayer/issues/8696.
