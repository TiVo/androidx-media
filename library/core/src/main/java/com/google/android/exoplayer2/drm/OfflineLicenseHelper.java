...
public final class OfflineLicenseHelper {
  ...
  public synchronized Pair<Long, Long> getLicenseDurationRemainingSec(byte[] offlineLicenseKeySetId) throws DrmSessionException {
    ...
    try {
      drmSession = acquireFirstSessionOnHandlerThread(DefaultDrmSessionManager.MODE_QUERY, offlineLicenseKeySetId, FORMAT_WITH_EMPTY_DRM_INIT_DATA);
    ...
    handler.post(() -> {
      try {
        licenseDurationRemainingSec.set(Assertions.checkNotNull(WidevineUtil.getLicenseDurationRemainingSec(drmSession)));
      } catch (Throwable e) {
              ...
              try {
                ...
                try {
                  ...
                  Assertions.checkNotNull(
                                  drmSessionManager.acquireSession(Objects.requireNonNull(Looper.myLooper()),eventDispatcher, format)));
                } catch (Throwable e) {
